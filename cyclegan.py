...
class CycleGAN:
    ...
    def train(self, epochs, batch_size=1, sample_interval=50):
        ...
        for epoch in range(epochs):
            for batch_i, (imgs_A, imgs_B) in enumerate(self.data_loader.load_batch(batch_size)):
                ...
                # print(f'imgs_B: {imgs_B}')

                # a = input()

                if imgs_A.ndim == 3 or imgs_B.ndim == 3:
                    continue
        ...
        self.d_A.save('Discriminator_A.h5')
        self.d_B.save('Discriminator_B.h5')

        self.g_AB.save('Generator_AB.h5')
        self.g_BA.save('Generator_BA.h5')
    ...
    def sample_images(self, epoch, batch_i):
        ...
        while not(imgs_A.ndim == 4 and imgs_B.ndim == 4):
            imgs_A = self.data_loader.load_data(domain="A", batch_size=1, is_testing=True)
            imgs_B = self.data_loader.load_data(domain="B", batch_size=1, is_testing=True)
            print(imgs_A.ndim)
            print(imgs_B.ndim)
